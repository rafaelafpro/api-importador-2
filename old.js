async function handleFile() {
    ...
    reader.onload = async function (event) {
        ...
        document.getElementById("jsonOutputReservas").value = JSON.stringify(
            reservas,
            null,
            2
        );
        document.getElementById("jsonOutputAcomodacoes").value = JSON.stringify(
            acomodacoes,
            null,
            2
        );
        document.getElementById("jsonOutputDespesas").value = JSON.stringify(
            despesas,
            null,
            2
        );
        document.getElementById("jsonOutputMovimentacoes").value =
